...
const contentTVShow = () => {
    ...
    const { data: movies, loading, error } = useApi<any>(`tv/${paramValue}?language=en-US&page=${page}`, 'GET');
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={styles.cardContainer}>
                        <Link style={{ marginLeft: 5, marginRight: 5 }} href={`aboutTV/${item?.id}` as any}>
